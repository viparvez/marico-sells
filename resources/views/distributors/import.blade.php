    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="col-4">
            ...
            <div class="card card-primary">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Import Distributors</h3>
              ...
              <form role="form" method="POST" action="{{route('distributors.handleimport')}}" enctype="multipart/form-data">
                ...
                <tbody>
                  ...
                  @foreach($report_error as $k => $v)
                    ...
                    <tr>
                      ...
                      <td>{{$v['message']}} at row number {{$v['RowNumber']}}</td>
        ...
        <div class="row col-12">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{asset('/samples/distributor.csv')}}" download>Download Sample Template</a>
