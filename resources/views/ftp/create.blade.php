    ...
    <section class="content">
      <div class="row">
        ...
        <div class="row col-12" style="background: white; padding-left: 10%; padding-top: 20px; padding-bottom: 20px; padding-right: 10%">
          ...
          <div class="col-6">
            <form class="form" method="POST" action="{{route('ftp.store')}}">
            {{csrf_field()}}

            <div class="form-group">
              <label for="">Server Address</label><code>(*)</code>
              <input type="text" class="form-control" name="server_name" placeholder="Server Address">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="port_number" placeholder="Please provide Port Numbner" value="21">
